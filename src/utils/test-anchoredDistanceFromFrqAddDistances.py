...
quartTable = tD.readAnchoredQuartTableFromFile(src_fpath)
...
Cpath = op+"/CountTable_test.ct"
Dpath = op+"/DistanceTable_test.dt"

tD.printDistanceTable(Dtmp,Ctmp,Dpath,Cpath)
