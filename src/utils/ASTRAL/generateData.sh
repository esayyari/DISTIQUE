...
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt1000 -q $p/$astral_1000_half -t 6 > $A1000half  2>$astral_1000_halfStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt200 -q $p/$astral_200_half -t 6 >   $A200half 2>$astral_200_halfStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt50 -q $p/$astral_50_half -t 6 > $A50half 2>$astral_50_halfStat ;

java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt1000 -q $p/$astral_1000_true -t 6 > $A1000true 2> $astral_1000_trueStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt200 -q $p/$astral_200_true -t 6 > $A200true 2> $astral_200_trueStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt50 -q $p/$astral_50_true -t 6 > $A50true 2> $astral_50_trueStat ;

java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt1000 -q $p/$njst_1000 -t 6 > $N1000half 2> $njst_1000_halfStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt200 -q $p/$njst_200 -t 6 > $N200half 2> $njst_200_halfStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt50 -q $p/$njst_50 -t 6 > $N50half 2> $njst_50_halfStat ;

java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt1000 -q $p/$concat_1000 -t 6 > $C1000half 2> $concat_1000_halfStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt200 -q $p/$concat_200 -t 6 > $C200half 2> $concat_200_halfStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $gt50 -q $p/$concat_50 -t 6 > $C50half 2> $concat_50_halfStat ;


java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt1000 -q $p/$njst_1000_true -t 6 > $N1000true 2> $njst_1000_trueStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt200 -q $p/$njst_200_true -t 6 > $N200true 2> $njst_200_trueStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt50 -q $p/$njst_50_true -t 6 > $N50true 2> $njst_50_trueStat ;

java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt1000 -q $p/$concat_1000_true -t 6 > $C1000true 2> $concat_1000_trueStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt200 -q $p/$concat_200_true -t 6 > $C200true 2> $concat_200_trueStat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -i $tgt50 -q $p/$concat_50_true -t 6 > $C50true 2> $concat_50_trueStat ;
...
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -q $s -i $gt1000 -t 6 > $A_trueSp1000half 2> $astral_1000_half_trueSp_Stat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -q $s -i $gt200 -t 6 > $A_trueSp200half 2> $astral_200_half_trueSp_Stat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -q $s -i $gt50  -t 6 > $A_trueSp50half 2> $astral_50_half_trueSp_Stat ;

java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -q $s -i $tgt1000 -t 6 > $A_trueSp1000true 2> $astral_1000_true_trueSp_Stat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -q $s -i $tgt200 -t 6 > $A_trueSp200true 2> $astral_200_true_trueSp_Stat ;
java -Xmx2000M -jar $WS_HOME/ASTRAL/astral.4.10.3.jar -q $s -i $tgt50  -t 6 > $A_trueSp50true 2> $astral_50_true_trueSp_Stat ;
...
cp $gt $TmpFolder
cp $tgt $TmpFolder
tar czvf $out/astral-PP2-BUG.tar.gz $TmpFolder
