...
#	fi
#	if [ -d $out/$tmp_out/cons ]; then
#		printf "the folder $out/$tmp_out/cons already exists\n"
#	else
#		printf "the folder $out/$tmp_out/cons created\n"
#		mkdir -p $out/$tmp_out/cons
#	fi
