...
case $m in
fm)
	$WS_HOME/"fastme"/src/fastme -i -m $d $met $res_root/distance.d -w none>$res_root/log.inof;
#	$WS_HOME/"fastme"/src/fastme -i $res_root/distance.d -o estimated_species_tree.tre >$res_root/log.inof;	
	;;
